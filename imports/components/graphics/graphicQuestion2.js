...
import './graphicQuestion2.html';

const name = 'graphicQuestion2';

class GraphicQuestion2Ctrl {
...
export default angular.module(name, [
  ...
  .component(name, {
    templateUrl: 'imports/components/graphics/graphicQuestion2.html',
    controllerAs: name,
    controller: GraphicQuestion2Ctrl
  })
  .config(config);
...
function config($stateProvider, $compileProvider, $logProvider) {
  ...
  $stateProvider.state('graphic-question-2', {
    url: '/graphic2',
    template: '<graphic-question-2></graphic-question-2>'
  });
}
